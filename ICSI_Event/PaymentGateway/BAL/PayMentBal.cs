...
namespace PaymentGateway.BAL
{
    public class PayMentBal
    {
        ...
        public int UpdatePaymentBal(string connectionString,string TxnID, DateTime TxnDate, string TxnCode, string TxnResponse, int RequestID, int paymentstatus,string paymode,double ST,double ProcFee,double totamt,double convfee)
        {
            PaymentDAL objPMDal = new PaymentDAL();
