...
namespace ICSI_Event.DBContext
{
    ...
    public partial class ICSI_EventsEntities : DbContext
    {
        ...
        public virtual DbSet<DIARY_REGISTRATION_T> DIARY_REGISTRATION_T { get; set; }
        public virtual DbSet<DIARY_T> DIARY_T { get; set; }
        public virtual DbSet<DIARY_TRANSACTION_T> DIARY_TRANSACTION_T { get; set; }
