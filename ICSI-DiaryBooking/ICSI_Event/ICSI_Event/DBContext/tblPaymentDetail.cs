...
namespace ICSI_Event.DBContext
{
    ...
    public partial class tblPaymentDetail
    {
        ...
        public virtual tblPaymentStatusMaster tblPaymentStatusMaster { get; set; }
        public virtual tblPayModeMaster tblPayModeMaster { get; set; }
        public virtual tblProcessMaster tblProcessMaster { get; set; }
    }
}
