   ...
   public class DiaryBooking
    {
        ...
        //[Required(ErrorMessage = "Name to be printed on Diary is Required")]
        [StringLength(50, ErrorMessage = "Length should be less than 50")]
        public string DiaryPName1 { get; set; }
        [StringLength(50, ErrorMessage = "Length should be less than 50")]
        public string DiaryPName2 { get; set; }
        [StringLength(50, ErrorMessage = "Length should be less than 50")]
        public string DiaryPName3 { get; set; }
        [StringLength(50, ErrorMessage = "Length should be less than 50")]
        public string DiaryPName4 { get; set; }
        [StringLength(50, ErrorMessage = "Length should be less than 50")]
        public string DiaryPName5 { get; set; }
